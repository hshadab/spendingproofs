...
if (result.decision.shouldBuy) {
  ...
  console.log('Proof hash:', result.proofHash);
      ...
      {/* Hosting Options */}
      <section id="hosting" className="py-16 px-6 border-t border-gray-800">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">Hosting Options</h2>
            <p className="text-gray-400 max-w-2xl mx-auto">
              The SDK runs in your app. The prover can be hosted or self-hosted. Choose what works for you.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-6 mb-8">
            ...
            <div className="bg-[#0a0a0a] border border-purple-500/30 rounded-xl p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <span className="text-xs text-purple-400">Runs in your app</span>
                </div>
              </div>
              <ul className="space-y-2 text-sm text-gray-400">
                <li className="flex items-start gap-2">
                  <Check className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>npm package, works anywhere</span>
                </li>
                <li className="flex items-start gap-2">
                  <Check className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>Client-side or server-side</span>
                </li>
                <li className="flex items-start gap-2">
                  <Check className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>Zero infrastructure from you</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-[#0a0a0a] border border-green-500/30 rounded-xl p-6 relative">
              <div className="absolute -top-3 right-4 bg-green-500 text-black text-xs font-semibold px-2 py-0.5 rounded">
                RECOMMENDED
              </div>
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h3 className="font-semibold">Hosted Prover</h3>
                  <span className="text-xs text-green-400">We run it for you</span>
                </div>
              </div>
              <ul className="space-y-2 text-sm text-gray-400 mb-4">
                <li className="flex items-start gap-2">
                  <Check className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>Free tier: 100 proofs/day</span>
                </li>
                <li className="flex items-start gap-2">
                  <Check className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
              ...
              <div className="bg-[#0d1117] rounded-lg p-3 font-mono text-xs">
                <span className="text-gray-500">proverUrl:</span>
                <br />
                <span className="text-green-400">&apos;https://prover.spendingproofs.dev&apos;</span>
              </div>
            </div>
            ...
            <div className="bg-[#0a0a0a] border border-cyan-500/30 rounded-xl p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h3 className="font-semibold">Self-Hosted Prover</h3>
                  <span className="text-xs text-cyan-400">Run your own</span>
                </div>
              </div>
              <ul className="space-y-2 text-sm text-gray-400 mb-4">
                <li className="flex items-start gap-2">
              ...
              <div className="bg-[#0d1117] rounded-lg p-3 font-mono text-xs">
                <span className="text-gray-500">$ </span>
                <span className="text-cyan-400">docker run -p 3001:3001</span>
                <br />
                <span className="text-cyan-400 pl-4">ghcr.io/arc/spending-prover</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-cyan-900/20 to-purple-900/20 border border-cyan-500/20 rounded-xl p-6">
            <h4 className="font-semibold mb-4">Self-Hosting Requirements</h4>
            <div className="grid md:grid-cols-4 gap-4 text-sm">
              <div>
                <div className="text-gray-500 mb-1">RAM</div>
                <div className="text-white font-medium">8GB minimum</div>
              </div>
              <div>
                <div className="text-gray-500 mb-1">CPU</div>
                <div className="text-white font-medium">4 cores recommended</div>
              </div>
              <div>
                <div className="text-gray-500 mb-1">Disk</div>
                <div className="text-white font-medium">2GB for models</div>
              </div>
              <div>
