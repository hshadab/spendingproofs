...
Uses power-of-two dimensions to ensure compatibility with the system requirements.
"""
...
class SimpleMLP(nn.Module):
    ...
    - Input: 8 dimensions (power of 2)
    - Hidden: 16 dimensions (power of 2) 
    - Output: 4 dimensions (power of 2)
...
# Create model
input_dim = 8    # Power of 2
hidden_dim = 16  # Power of 2  
output_dim = 4   # Power of 2
...
print(f"  Input dimension: {input_dim} (power of 2)")
print(f"  Hidden dimension: {hidden_dim} (power of 2)")
print(f"  Output dimension: {output_dim} (power of 2)")
